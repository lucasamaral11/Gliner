...
async def chamar_ollama(
    ...
    try:
        ...
        logger.info(
            "request_id=%s | ollama_duration=%.3fs | http_status=%s",
            request_id,
            duracao_ollama,
...
async def request_logging_middleware(
    ...
    try:
        ...
        logger.exception(
            "request_id=%s | method=%s | path=%s | exception | duration=%.3fs",
            request_id,
            request.method,
            request.url.path,
            duracao,
...
async def extrair_oferta(
    ...
    logger.info(
        "request_id=%s | oferta recebida | text_length=%d",
        request_id,
        len(payload.texto),
    )
    ...
    try:
        ...
        logger.info(
            "request_id=%s | oferta concluída | duration=%.3fs",
            request_id,
            duracao,
        )
        ...
        logger.warning(
            "request_id=%s | oferta falhou | duration=%.3fs",
            request_id,
            duracao,
        )
        ...
        logger.exception(
            "request_id=%s | erro inesperado | duration=%.3fs",
            request_id,
            duracao,
        )
